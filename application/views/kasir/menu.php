                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <div class="navbar">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li>
                                            <?php
                                            $keranjang = 'Keranjang <i class="fa-solid fa-cart-shopping"></i> : ' . $this->cart->total_items() . ' Items';
                                            ?>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="card mb-3" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text badge badge-success">Rp. <?= number_format($dat['harga'], 2); ?></p><br>
